...
{:.d-startup}
L’App IO costituisce il canale mobile del c.d. Punto di accesso telematico di cui all’art. 64-bis del D.Lgs. 82/2005 (Codice dell’Amministrazione Digitale - “CAD”). L’App IO è gestita dalla società PagoPA S.p.A. (“**PagoPA**”) su incarico della Presidenza del Consiglio dei Ministri.<br>
...
- PagoPA tratta i tuoi dati come titolare per le attività necessarie alla progettazione, sviluppo, gestione e implementazione dell’App IO, per le attività relative alle funzionalità e ai servizi erogati da PagoPA direttamente ai cittadini e per tutte le altre attività che sono attribuite a PagoPA dalla legge per l’esecuzione di compiti di interesse pubblico; i singoli Enti rimangono invece titolari per i servizi che erogano tramite l’App e puoi consultare le relative informative privacy nella sezione “Servizi”. **Alcuni servizi o alcune funzionalità, in particolare ove riferiti all’emergenza epidemiologica da COVID-19, potrebbero comportare il trattamento di particolari categorie di dati (es. dati relativi allo stato di salute). Trovi le informazioni sul trattamento di questi dati nelle informative dei relativi servizi.**;
- Ti ricordiamo che su IO riceverai solo messaggi a te espressamente indirizzati. Puoi comunque scegliere quali servizi degli Enti aderenti possono contattarti e come (messaggi in app e notifiche push), e potrai sempre modificare la tua scelta nelle Preferenze della sezione Profilo o nella scheda di dettaglio del singolo Servizio. Puoi inoltre impostare la preferenza globale rispetto all’inoltro via email dei messaggi in app, nel menu Preferenze della sezione Profilo.
- Per il momento, le notifiche push avranno sempre contenuto generico. Puoi disattivare le notifiche push per singolo servizio (nella relativa scheda) oppure disattivare tutte le notifiche push dalle impostazioni del tuo dispositivo.
- Ti ricordiamo che la tua scelta su quali servizi possono contattarti non incide sull’iscrizione a determinati Servizi (ad esempio, i Bonus), per cui se decidi di non voler ricevere comunicazioni da un Servizio a cui hai aderito, l’Ente erogatore non potrà contattarti ma rimarrà attiva la tua iscrizione al Servizio (e potrai continuare a beneficiare dei relativi vantaggi) fino a che non deciderai di revocare l’iscrizione nell’apposita scheda Servizio.
- Per finalità di diagnostica e debug utilizziamo strumenti di tracciamento che ci permettono di raccogliere dati relativi all’utilizzo dell’App da parte degli utenti. Alcuni dei dati acquisiti con questi strumenti sono associati univocamente a te, ma non sono mai utilizzati per finalità di marketing o profilazione. Alcuni di questi dati vengono aggregati e successivamente utilizzati per consentirci di effettuare elaborazioni sull’uso dei nostri prodotti e servizi. Chiediamo il tuo consenso all’utilizzo di tali strumenti di tracciamento: il tuo consenso è facoltativo, e puoi modificarlo in ogni momento nella sezione Preferenze.
- Quando richiedi assistenza attraverso le apposite funzionalità in app, verranno raccolti automaticamente alcuni dati relativi al tuo dispositivo, compresi alcuni dati personali necessari per trasmettere la segnalazione al team di assistenza e per risolvere il tuo ticket. Se utilizzi tali funzionalità, non è possibile escludere la raccolta automatica di tali dati, ma puoi comunque utilizzare gli altri canali di assistenza messi a disposizione (ad esempio email) che non prevedono tale raccolta automatica, tenendo presente che i nostri operatori potrebbero comunque avere bisogno di chiederti tali dati per risolvere la problematica. I servizi di terze parti che utilizziamo per fornirti assistenza potrebbero inoltre raccogliere immagini e video pertinenti alla tua segnalazione, direttamente dall’app o su tua richiesta, e in tal caso è richiesta una tua conferma prima dell’invio nonché, ove desideri allegare tali file, il permesso di accesso in lettura alla memoria di archiviazione del tuo dispositivo per consentire la trasmissione degli allegati. Per maggiori informazioni sul trattamento dei dati tramite i nostri canali di assistenza, consulta l’informativa specifica all’indirizzo <https://www.pagopa.it/it/privacy-policy-assistenza/>;
- Alcuni dei nostri fornitori o delle terze parti coinvolte nel funzionamento dell’App sono situati al di fuori dell’UE, ivi inclusi gli USA. Ti garantiamo che anche in caso di eventuale trasferimento, **i tuoi dati sono al sicuro**, e che tutti i nostri fornitori assicurano sempre il rispetto delle misure di garanzia previste dal Regolamento (UE) 2016/679 (GDPR). In particolare, abbiamo previsto con tutti i fornitori stabiliti all’estero adeguate misure di garanzia, incluse le clausole contrattuali standard, per assicurare la tutela dei tuoi dati. Puoi consultare la lista dei responsabili e le relative garanzie collegandoti a questo indirizzo: <https://io.italia.it/app-content/fornitori/>;
- L'App IO è integrata con la Piattaforma pagoPA, la piattaforma tecnologica che gestisce i pagamenti dei cittadini verso lo Stato; quindi se hai già utilizzato pagoPA, ritroverai su IO lo storico delle tue transazioni sotto la sezione "Portafoglio";
- Per alcuni servizi o funzionalità avrai la possibilità di conservare e/o inviare alcune informazioni mediante i sistemi e le app di terze parti installate nel tuo dispositivo, ad esempio salvare file sul tuo dispositivo o condividerli con l’esterno, impostare scadenze nel tuo calendario, caricare o catturare Qr code o immagini; in tali casi è richiesto il permesso di accesso, in lettura e/o scrittura a seconda dei casi, al Tuo calendario, alla fotocamera e/o alla memoria del tuo dispositivo e potrebbe comportare la condivisione di informazioni con i fornitori delle app da te scelte per la condivisione di file, il calendario, la fotocamera e l’archiviazione, secondo i termini e condizioni previsti da tali fornitori terze parti. Tale accesso è disattivato di default, quindi nessun dato potrà essere raccolto e inviato in mancanza di tua espressa autorizzazione. Potrai sempre modificare i permessi dell’App dalle impostazioni del tuo dispositivo.
...
- ove previsto, di conservare e/o inviare alcune informazioni mediante i sistemi e le app di terze parti installate nel tuo dispositivo, in particolare per consentirti di salvare file sul tuo dispositivo o condividerli con l’esterno.
...
Queste informazioni sono associate al tuo codice fiscale e memorizzate nei nostri sistemi. Conserviamo inoltre, per un periodo di tempo limitato, lo storico degli accessi e delle preferenze. <br>
...
Per maggiori informazioni sul trattamento dei dati tramite i nostri canali di assistenza, consulta l’informativa specifica all’indirizzo <https://www.pagopa.it/it/privacy-policy-assistenza/>.
...
{:.d-more-1}
I dati relativi ai Messaggi sono cancellati dopo 3 anni dalla loro ricezione. Ti ricordiamo che puoi scaricare copia dei tuoi Messaggi in ogni momento in app, dal menu Profilo > Privacy e Condizioni d’uso > Accedi ai tuoi dati.

{:.d-more-1}
I dati trattati in ragione delle attività di assistenza vengono conservati per 12 mesi.
...
{:.d-more-1}
I dati trattati in ragione delle attività di debug e diagnostica sono conservati per 24 mesi.

{:.d-more-1}
I dati trattati in ragione delle attività necessarie per garantire la sicurezza sono conservati per 6 mesi.
...
{:.d-more-1}
Hai il diritto di ottenere la cancellazione dei dati personali che ti riguardano, nei limiti e nei casi previsti dal GDPR, anche utilizzando la **funzione “Elimina il tuo account”** nella sezione “Profilo” cliccando su “Privacy e condizioni d’uso” dell’App IO.<br>
...
{:.d-more-2}
Per accedere all’App IO devi scaricarla e installarla su un dispositivo mobile compatibile.
