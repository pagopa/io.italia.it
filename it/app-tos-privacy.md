...
- Abbiamo aggiornato le sezioni che riguardano i trattamenti relativi all’autenticazione in app e i relativi tempi di conservazione;
- Abbiamo inserito alcune previsioni che riguardano la disponibilità e l'eventuale interruzione dei nostri servizi su dispositivi e/o sistemi operativi non supportati da IO.
...
- Abbiamo inserito alcune previsioni che riguardano la disponibilità e l’eventuale interruzione dei nostri servizi su dispositivi e/o versioni di sistemi operativi non supportati da IO.
...
Siamo sempre all’opera per offrirTi nuove funzionalità e nuovi servizi, pertanto aggiorniamo regolarmente l’App IO per assicurarTi un utilizzo ottimale e per migliorare l’esperienza del cittadino, e per questo Ti consigliamo di scaricare e installare tutti gli aggiornamenti pubblicati. Tieni presente che in virtù della continua evoluzione dei nostri standard di sicurezza, alcuni dispositivi e/o versioni di sistemi operativi potrebbero non essere compatibili con IO. Ti avviseremo in anticipo quando cesserà il supporto per questi dispositivi e versioni dei sistemi operativi, fornendoTi le informazioni necessarie per continuare ad utilizzare l'App, ove possibile.
