...
<section class="sicurezza__wrapper">
	...
	Il fatto stesso di essere open source garantisce sta alla base dell'approccio alla sicurezza del progetto IO, che inverte il paradigma della “sicurezza tramite segretezza”: i codici dell’applicazione e delle piattaforme di back end sono infatti a disposizione di tutti, compresi coloro che scelgono di dare una mano segnalando malfunzionamenti ed eventuali bug.</p><p class="text-justify mw-40 sicurezza__paragraph">
